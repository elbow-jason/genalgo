...
$gene.Mutate = function(){
  ...
  this.insert = function(sequence){
    ...
    fragment = this.sliceSeq(sequence, fragment);
    return fragment;
  };
  ...
  this.sliceSeq = function(sequence, fragment){
    ...
    slicedSeq = sequence.slice(0,injectAddr) + fragment + sequence.slice(injectAddr, sequence.length);
    return slicedSeq;
  }
  ...
  this.randReverse = function(sequence){
    return $gene.torf() ? this.reverse(sequence) : sequence;
  };
