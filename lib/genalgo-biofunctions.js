...
biofuncs.prototype.replicate = function(oldOrganism, replicatedOrganismName){
    //init organism
...
biofuncs.prototype.ingest = function(organism, food){
    organism.fuel += food.fuel;
    food.fuel = 0;
  };

biofuncs.prototype.act = function(organism, organismAndKey, func, value, cost){
