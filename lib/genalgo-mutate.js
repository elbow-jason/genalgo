...
mutate.prototype.randMutation = function(){

};


mutate.prototype.point  = function(sequence, symbols, mutPointIndex, mutSymbolIndex){
...
mutate.prototype.insert = function(sequence, fragment, injectAddr){
...
mutate.prototype.mutInsert = function(sequence){
...
mutate.prototype.fragment = function(sequence, frag1Index, frag2Index){
  var finalFrag;
...
mutate.prototype.fracture = function(sequence, seqIndex){
  var frag1 = sequence.slice(0,seqIndex);
      frag2 = sequence.slice(seqIndex, sequence.length);
      return [frag1, frag2];
};

mutate.prototype.mutFracture = function(sequence){
  return mutate.fracture(sequence, helpers.randIndex(sequence));
};


mutate.prototype.transpose = function(frag1, frag2, frag3, frag4){
  return [frag1+frag2, frag3+frag4];
};

mutate.prototype.mutTranspose = function(seq1, seq2){
...
mutate.prototype.deletion = function(sequence, delIndex, numOfDeletions){
  sequence1 = sequence1.splice(delIndex, numOfDeletions);
  return 
};

mutate.prototype.MutDelPoint = function(sequence){};



mutate.prototype.mutPoint = function(sequence, symbols) {
